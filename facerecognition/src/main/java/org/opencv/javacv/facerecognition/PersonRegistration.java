...
public class PersonRegistration extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DateofBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(PersonRegistration.this, date, myCalendar
        ...
        Dateofjoining.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(PersonRegistration.this, date2, myCalendar2
        ...
        String tempImage = preferences.getString("Image", "");
        byte[] byteArray = Base64.decode(tempImage, Base64.DEFAULT);
        bmp = BitmapFactory.decodeByteArray(byteArray,0,byteArray.length);
        String tempcnic = preferences.getString("CNIC","");
        Cnic.setText(tempcnic);
...
//        }
    ...
    public void Registration(View view)
    {
        ...
        else
        {
            ...
            {
                String testrole = Role.getSelectedItem().toString();
                String testcnic = Cnic.getText().toString();
                if(testrole=="Staff")
                {
                    updatelistfile(testcnic);
                }

                //     final ProgressDialog loading = ProgressDialog.show(this,"Registering...","Please wait...",false,false);
                RequestQueue requestQueue = Volley.newRequestQueue(PersonRegistration.this);
                StringRequest request = new StringRequest(Request.Method.POST, "http://real-time-face-recognition.000webhostapp.com/Mobile/Registration.php", new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        if (response.equals("success")) {
                            Toast.makeText(PersonRegistration.this, "Registration Successful", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(PersonRegistration.this, "Registration Failed:" + response, Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PersonRegistration.this, message, Toast.LENGTH_LONG).show();
                    }
                }
                ) {
                    @Override
    ...
    private void UploadImage(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://real-time-face-recognition.000webhostapp.com/Mobile/PhotoUpload.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                String s = response.trim();
                if(s.equalsIgnoreCase("success")){
                    Toast.makeText(PersonRegistration.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(PersonRegistration.this, "Image Uplaod Failed", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PersonRegistration.this, message , Toast.LENGTH_LONG).show();
                //Toast.makeText(PersonRegistration.this, error+"", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
